    ...
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-2xl">
        <div class="container mx-auto mt-8">
            ...
            <form action="{{ route('productos.store') }}" method="post" enctype="multipart/form-data" class="max-w-md">
                ...
                <div class="mb-4">
                    <label for="tipos_id" class="block text-sm font-medium text-gray-600">Tipo: </label>
                    <select name="tipos_id" class="mt-1 p-2 w-full border rounded-md" required>
                ...
                <div class="mb-4" id="nuevoTipo" style="display: none;">
                    <label for="nuevo_tipo_plato" class="block text-sm font-medium text-gray-600">Nuevo Tipo: </label>
                    <input type="text" name="nuevo_tipo" class="mt-1 p-2 w-full border rounded-md">
                </div>
                ...
                <div class="mb-4">
                    <label for="categorias_id" class="block text-sm font-medium text-gray-600">Categoría:</label>
                    <select name="categorias_id" class="mt-1 p-2 w-full border rounded-md" required>
