...
class PermissionTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $permissions = [
            ...
            'Ver-Plato', 'Crear-Plato', 'Editar-Plato', 'Borrar-Plato',
            'Ver-Bebida', 'Crear-Bebida', 'Editar-Bebida', 'Borrar-Bebida',
            'Ver-Orden', 'Crear-Orden', 'Editar-Orden', 'Borrar-Orden',
            'Ver-Rerservacion', 'Crear-Reservacion', 'Editar-Reservacion', 'Borrar-Reservacion'
