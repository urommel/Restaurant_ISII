    ...
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-2xl">
        <div class="container mx-auto mt-8">
            ...
            <form action="{{ route('productos.store') }}" method="post" enctype="multipart/form-data" class="max-w-md">
                ...
                <div class="mb-4">
                    <label for="tipoPlato" class="block text-sm font-medium text-gray-600">Tipo de Plato:</label>
                    <select name="tipoPlato" class="mt-1 p-2 w-full border rounded-md" required>
                ...
                <div class="mb-4" id="nuevoTipoPlato" style="display: none;">
                ...
                <div class="mb-4">
                    ...
                    <select name="categoria_id" class="mt-1 p-2 w-full border rounded-md" required>
                        ...
                        @endforeach
                        <option value="nuevaCa">Crear Nueva Categoría</option>
                    </select>
                </div>
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        const tipoPlatoDropdown = document.querySelector('select[name="tipoPlato"]');
        const nuevoTipoPlatoDiv = document.getElementById('nuevoTipoPlato');
