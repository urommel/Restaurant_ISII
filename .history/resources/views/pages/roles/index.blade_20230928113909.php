                        ...
                        <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                <div>
                                    ...
                                    <!-- Agregar espacio horizontal entre los botones con la clase "ml-2" (o el valor que desees) -->
                                    <a href="#" class="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center ml-2 dark:bg-white dark:hover:bg-white dark:text-black dark:focus:ring-white">
