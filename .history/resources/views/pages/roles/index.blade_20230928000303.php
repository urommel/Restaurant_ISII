                    ...
                    @foreach ($roles as $role)
                        ...
                        <td class="px-6 py-4">
                            ...
                            <td class="px-6 py-4">
                                ...
                                <div class="flex flex-wrap p-2 space-x-2 bg-blue-500 rounded-lg dark:bg-blue-700 dark:text-blue-100">
                                    @foreach ($permissions as $permission)
                                        <div class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                            {{ $permission }},
                                        </div>
                                    @endforeach
                                </div>
