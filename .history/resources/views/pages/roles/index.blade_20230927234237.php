                            ...
                            <td class="px-6 py-4">
                                <ul>
                                    ...
                                    <div class="grid grid-cols-4 gap-4">
                                        @foreach (array_chunk($role->permissions, 4) as $chunk)
                                            <div class="bg-{{ random_color() }} p-4 rounded-lg">
                                                <ul>
                                    ...
                                    function random_color() {
                                        $colors = ['red-500', 'blue-500', 'green-500', 'yellow-500', 'purple-500', 'pink-500', 'indigo-500', 'teal-500'];
