                            ...
                            <td class="px-6 py-4">
                                <ul class="list-disc list-inside">
                                    ...
                                    @for ($i = 0; $i < count($permissions); $i+=4)
                                        <li>
                                            <ul class="px-2 py-1 font-semibold leading-tight text-green-700 bg-green-100 rounded-full dark:bg-green-700 dark:text-green-100">
                                                @for ($j = $i; $j < min($i + 4, count($permissions)); $j++)
                                                    <li>{{ $permissions[$j] }}</li>
                                                @endfor
                                            </ul>
                                        </li>
