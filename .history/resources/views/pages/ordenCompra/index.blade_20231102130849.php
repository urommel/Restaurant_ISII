<x-app-layout>
    ...
    <a href="{{ route('ordenes-compra.create') }}" class="bg-blue-500 text-white py-2 px-4 rounded mb-4 inline-block">Crear Nueva Orden de Compra</a>
                ...
                @foreach ($ordenesCompra as $orden)
                    <tr>
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">
                            <a href="{{ route('ordenes-compra.show', $orden->id) }}" class="text-blue-500 hover:underline">Ver Detalles</a>
                        </td>
                    </tr>
                @endforeach
            </tbody>
