        ...
        <div class="container mx-auto">
            ...
            <form action="{{ route('proveedors.store') }}" method="POST" class="max-w-lg">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="compañia" id="compañia" class="form-input mt-1 block w-full rounded-md shadow-sm" placeholder="Compañia" />
                </div>
    
                <div class="mb-4">
                    <label for="representante" class="block text-sm font-medium text-gray-600">Representante:</label>
                    <input type="text" name="representante" id="representante" class="form-input mt-1 block w-full rounded-md shadow-sm" placeholder="Representante" />
                </div>
    
                <div class="mb-4">
                    <label for="ruc" class="block text-sm font-medium text-gray-600">Ruc:</label>
                    <input type="text" name="ruc" id="ruc" class="form-input mt-1 block w-full rounded-md shadow-sm" placeholder="Ruc" />
                </div>
    
                <div class="mb-4">
                    <label for="celular" class="block text-sm font-medium text-gray-600">Celular:</label>
                    <input type="text" name="celular" id="celular" class="form-input mt-1 block w-full rounded-md shadow-sm" placeholder="Celular" />
                </div>
    
                <div class="mb-4">
                    <label for="direccion" class="block text-sm font-medium text-gray-600">Direccion:</label>
                    <input type="text" name="direccion" id="direccion" class="form-input mt-1 block w-full rounded-md shadow-sm" placeholder="Direccion" />
                </div>
    
                <div class="mb-4">
                    <label for="email" class="block text-sm font-medium text-gray-600">Email:</label>
                    <input type="text" name="email" id="email" class="form-input mt-1 block w-full rounded-md shadow-sm" placeholder="Email" />
                </div>
