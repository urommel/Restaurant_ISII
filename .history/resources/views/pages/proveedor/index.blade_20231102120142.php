    ...
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        <div class="container mx-auto">
            <div class="flex justify-between items-center mb-4">
                ...
                <a href="{{ route('proveedor.create') }}" class="btn btn-primary">Create New</a>
            </div>
                            ...
                            <tr>
                                ...
                                <td class="border px-4 py-2">
                                    <form action="{{ route('proveedor.destroy', $proveedor->idProveedor) }}"
                                        method="POST">
                                        <a href="{{ route('proveedors.show', $proveedor->idProveedor) }}"
                                            class="btn btn-primary">Show</a>
                                        <a href="{{ route('proveedors.edit', $proveedor->idProveedor) }}"
