    ...
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg">
            ...
            <nav class="flex items-center justify-between pt-4" aria-label="Table navigation">
                ...
                {{-- <span class="text-sm font-normal text-gray-500 dark:text-gray-400">Mostrar <span
                        class="font-semibold text-gray-900 dark:text-white">1-10</span> de <span
                        class="font-semibold text-gray-900 dark:text-white">1000</span>
                </span> --}}
                {{-- <ul class="inline-flex h-8 -space-x-px text-sm">
                    <li>
                        <a href="#"
                            class="flex items-center justify-center h-8 px-3 ml-0 leading-tight text-gray-500 bg-white border border-gray-300 rounded-l-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Anterior</a>
                    </li>
                    <li>
                        <a href="#"
                    ...
                    <li>
                        <a href="#"
                            class="flex items-center justify-center h-8 px-3 leading-tight text-gray-500 bg-white border border-gray-300 rounded-r-lg hover:bg-gray-100 hover:text-gray-700 dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Siguiente</a>
                    </li>
                </ul> --}}
            </nav>
        </div>
        ...
        {{-- <div class="container mx-auto mt-8">
            <h1 class="mb-4 text-2xl font-semibold">Roles y Permisos</h1>
            <div class="mb-4">
                <h2 class="mb-2 text-xl font-semibold">Roles:</h2>
                <ul>
                    @foreach ($roles as $role)
                        <li>{{ $role->name }}</li>
                    @endforeach
            ...
            <div class="mb-4">
                <h2 class="mb-2 text-xl font-semibold">Permisos:</h2>
                <ul>
