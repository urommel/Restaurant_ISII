<x-app-layout>
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        ...
        <div class="container mx-auto">
            ...
            <a href="{{ route('clients.create') }}" class="bg-blue-500 text-white py-2 px-4 mb-4 rounded">Nuevo Cliente</a>
                        ...
                        <tr>
                            ...
                            <td class="border px-4 py-2">
                                ...
                                <form action="{{ route('clients.destroy', $client->id) }}" method="POST" class="inline">
                                    @csrf
                                    @method('DELETE')
                                    <button type="submit" class="text-red-500 ml-2" onclick="return confirm('¿Estás seguro?')">Eliminar</button>
                                </form>
                            </td>
                        </tr>
                    @endforeach
