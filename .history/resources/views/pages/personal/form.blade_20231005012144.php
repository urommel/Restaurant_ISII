<div class="grid gap-6 mb-6 md:grid-cols-2">
    ...
    <div>
        ...
        <div class="relative">
            ...
            <input datepicker type="text" class="datepicker-input" name="fecha_inicio" placeholder="Selecciona una Fecha" value="{{ old('fecha_inicio', $personal->fecha_inicio ?? '') }}" required>
        </div>
    </div>
