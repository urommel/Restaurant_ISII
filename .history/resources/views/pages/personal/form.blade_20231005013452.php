    ...
    <div>
        ...
        <div class="relative">
            ...
            {{-- <input id="fechaInput" type="text"
                ...
                name="fecha_inicio" placeholder="Selecciona una Fecha"
                value="{{ old('fecha_inicio', $personal->fecha_inicio ?? '') }}" required> --}}
            <input id="fechaInput" type="text" class="dark" name="fecha_inicio" placeholder="Selecciona una Fecha"
                value="{{ old('fecha_inicio', $personal->fecha_inicio ?? '') }}" required>
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        flatpickr('#fechaInput', {
            ...
            enable: [{
                from: 'today',
                to: new Date().getFullYear() + 5, // Habilitar años hasta 5 años en el futuro
            }],
            // Puedes agregar más opciones de configuración aquí según tus necesidades
        });
    });
