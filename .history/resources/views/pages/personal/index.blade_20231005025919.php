                    ...
                    <tr>
                        <th scope="col" class="p-4">
                            ...
                            <div class="flex items-center">
                                ...
                                <a href="{{ route('personal.edit', $personal->id) }}" class="text-white focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-full text-sm p-2.5 text-center inline-flex items-center dark:bg-white dark:hover:bg-white dark:text-black dark:focus:ring-white">
...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        // Obtén el checkbox de selección general
        const selectAllCheckbox = document.getElementById('selectAll');

        // Obtén todos los checkboxes de elementos individuales
        const itemCheckboxes = document.querySelectorAll('.item-checkbox');

        // Maneja el evento de cambio en el checkbox de selección general
        selectAllCheckbox.addEventListener('change', function () {
            // Itera sobre todos los checkboxes de elementos individuales
            itemCheckboxes.forEach(function (checkbox) {
                // Establece el estado del checkbox de elemento individual igual al estado del checkbox de selección general
