<div class="grid gap-6 mb-6 md:grid-cols-2">
    ...
    <div>
        ...
        @if (isset($personal) && $personal->user->profile_photo_path)
            <p class="text-gray-500 dark:text-gray-400 mb-2">Ya hay una foto cargada.</p>
        ...
        @else
            <!-- Campo para cargar foto cuando no hay foto existente -->
            <input
                class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
                id="file_input" type="file" name="profile_photo" required>
        @endif
