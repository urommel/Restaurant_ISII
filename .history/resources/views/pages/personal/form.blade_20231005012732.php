<style>
    ...
    .dark .flatpickr-yearDropdown-years {
        background: #2d2d2d;
        color: #fff;
    }
</style>
    ...
    <div>
        ...
        <div class="relative">
            ...
            {{-- <input id="fechaInput" type="text"
                ...
                name="fecha_inicio" placeholder="Selecciona una Fecha"
                value="{{ old('fecha_inicio', $personal->fecha_inicio ?? '') }}" required> --}}
                <input id="fechaInput" type="text" class="datepicker-input bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" name="fecha_inicio" placeholder="Selecciona una Fecha" value="{{ old('fecha_inicio', $personal->fecha_inicio ?? '') }}" required>
...
{{-- <script>
    document.addEventListener('DOMContentLoaded', function() {
        flatpickr('.datepicker-input', {
            dateFormat: 'Y-m-d',
            theme: 'dark', // Configura el tema oscuro
            enable: [{
                from: 'today',
                to: new Date().getFullYear() + 5, // Habilita los años hasta 5 años en el futuro
            }, ],
            // Puedes agregar más opciones de configuración aquí según tus necesidades
        });
    });
</script> --}}
