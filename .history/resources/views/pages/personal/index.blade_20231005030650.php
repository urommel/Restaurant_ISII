...
<script>
    $(document).ready(function () {
        // Evento de clic en el checkbox general
        $("#checkbox-all-search").click(function () {
            // Marcar o desmarcar todos los checkboxes individuales
            $(".checkbox-item").prop('checked', $(this).prop('checked'));
        });

        // Evento de clic en los checkboxes individuales
        $(".checkbox-item").click(function () {
            // Verificar si todos los checkboxes individuales están marcados y actualizar el checkbox general en consecuencia
            $("#checkbox-all-search").prop('checked', $(".checkbox-item:checked").length === $(".checkbox-item").length);
        });
    });
</script>
