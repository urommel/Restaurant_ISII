                        ...
                        <div
                            ...
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                                @foreach ($categorias as $categoria)
                                    <li class="mr-2">
                                        <button id="{{ $categoria->nombre }}-tab" data-tabs-target="#{{ $categoria->nombre }}" type="button" role="tab" aria-controls="{{ $categoria->nombre }}" aria-selected="true" class="inline-block p-4 text-blue-600 rounded-tl-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700 dark:text-blue-500">{{ $categoria->nombre }}</button>
                                    </li>
                                @endforeach
                            </ul>
                            ...
                            <div class="tab-content">
                                @foreach ($categorias as $categoria)
                                    <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800"
                                        id="{{ $categoria->id }}" role="tabpanel"
                                        aria-labelledby="{{ $categoria->id }}-tab">
