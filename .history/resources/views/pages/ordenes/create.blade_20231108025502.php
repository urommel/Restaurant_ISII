                ...
                <div class="">
                    <div class="divide-y-2">
                        <div
                            ...
                            <!-- Agregar un bucle para las categorías -->
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800"
                                id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
                                @foreach ($categorias as $categoria)
                                    <li class="mr-2">
                                        <button data-tabs-target="#{{ Str::slug($categoria->nombre) }}" type="button"
                                            role="tab" aria-controls="{{ Str::slug($categoria->nombre) }}"
                            ...
                            <!-- Agregar un bucle para mostrar productos según categoría -->
                    ...
                    @foreach ($productos->where('categoria_id', $categoria->id) as $producto)
                        <div class="mb-8 producto-container bg-red-50">
                            ...
                            <div class="flex justify-center">
                                <a href="#">
                                    <img class="object-cover w-32 h-32 p-4 rounded-lg" src="{{ $producto->imagen }}" alt="product image" />
                                </a>
                            </div>
