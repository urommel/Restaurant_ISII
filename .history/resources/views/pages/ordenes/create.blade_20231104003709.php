                ...
                <div class="divide-y-2">
                    ...
                    <div class="relative mt-8 overflow-x-auto border border-transparent shadow-md sm:rounded-lg">
                        ...
                        <div class="absolute top-0 right-0 mt-4 mr-4">
                            <span class="text-lg font-bold text-gray-700 dark:text-gray-400">Monto Total:</span>
                            <span id="montoTotal" class="ml-2 text-lg font-bold text-gray-900 dark:text-gray-400">\$0.00</span>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    ...
    function addToCart(nombre, precio) {
        ...
        celdaEliminar.innerHTML = '<a href="#" class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Delete</a>';
        ...
        inputCantidad.classList.add('w-16', 'px-2', 'py-1', 'ml-4', 'text-sm', 'text-gray-900', 'bg-white', 'border', 'border-gray-300', 'rounded-lg', 'dark:bg-gray-800', 'dark:border-gray-700', 'dark:text-gray-400');
