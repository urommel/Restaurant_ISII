...
<script>
    ...
    // Función para enviar la información del carrito al controlador
    function enviarCarrito() {
        // Crear un campo de entrada oculto para almacenar la información del carrito
        const inputCarrito = document.createElement('input');
        inputCarrito.type = 'hidden';
        inputCarrito.name = 'productos';
        inputCarrito.value = JSON.stringify(obtenerInformacionCarrito());
        document.getElementById('formularioOrden').appendChild(inputCarrito);

        // Enviar el formulario
        document.getElementById('formularioOrden').submit();
    }
    ...
    function obtenerInformacionCarrito() {
        ...
        filasProductos.forEach((fila) => {
            ...
            const precioUnitario = parseFloat(fila.querySelector('td:nth-child(4)').textContent.replace('$', ''));
