                        ...
                        <div
                            ...
                            <div id="defaultTabContent">
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                    ...
                                    <div class="relative space-y-8 slick-carousel">
                                        <button class="absolute left-0 flex items-center justify-center w-8 h-8 transform -translate-y-1/2 bg-gray-200 rounded-full top-1/2">
                                        ...
                                        <button class="absolute right-0 flex items-center justify-center w-8 h-8 transform -translate-y-1/2 bg-gray-200 rounded-full top-1/2">
                                          <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor" class="w-4 h-4 text-gray-600">
                                        ...
                                        @foreach ($bebidas as $index => $bebida)
                                            <div
                                                ...
                                                <div class="flex justify-center">
                                                    <a href="#">
                                                        <img class="object-cover w-32 h-32 p-4 rounded-lg"
                                                            src="/docs/images/products/beverage.png"
                                                            alt="product image" />
                                                    </a>
                                                </div>
                                                <div class="px-4 py-3 mt-auto">
