                    ...
                    <div
                        ...
                        <div id="defaultTabContent">
                            ...
                            <form action="{{ route('orden.store') }}" method="POST" role="form">
                                ...
                                <button type="submit" id="botonCrearOrden" class="w-full mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                                    Crear Orden
                                </button>
                            </form>
