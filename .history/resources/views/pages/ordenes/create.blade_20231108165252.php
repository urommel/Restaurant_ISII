                        ...
                        <div
                            ...
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800"
                                ...
                                <li class="mr-2">
                                    <button data-tabs-target="#sopas" type="button" role="tab"
                                        aria-controls="sopas" aria-selected="false"
                                        class="inline-block p-4 hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700">Menu del Dia</button>
                                </li>
                            </ul>
...
<script>
    ...
    function crearOrden() {
    // Obtén los detalles de la orden (mesero, número de mesa, cliente, observaciones, productos)
    ...
    // Obtén las filas de productos en la tabla
    const filasProductos = document.querySelectorAll("#tablaProductosBody tr");
    const productos = [];
    ...
    // Envía una solicitud al servidor Laravel para crear la orden
