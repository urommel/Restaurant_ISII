                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                @foreach ($platos as $plato)
                                    ...
                                    <div class="flex flex-wrap justify-center">
                                        <div class="mx-2 my-4 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                            <a href="#">
                                                <img class="p-4 rounded-t-lg" src="/docs/images/products/apple-watch.png" alt="product image" />
                                            </a>
