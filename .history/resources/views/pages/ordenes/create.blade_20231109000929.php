...
<script>
    ...
    function addToCart(nombre, precio) {
        const cantidadInput = document.getElementById(`quantity_${nombre.replace(/\s+/g, '_')}`);
        const cantidad = parseInt(cantidadInput.value);

        const precioTotalUnitario = (cantidad * precio).toFixed(2);
        const precioTotal = parseFloat(precioTotalUnitario);
        ...
        productos.push({
            ...
            precioTotalUnitario: precioTotalUnitario,
    ...
    function pagar() {
        // Actualizamos el campo oculto con la información de los productos
        ...
        document.forms[0].submit(); // Puedes ajustar el índice del formulario según tu estructura HTML
    }
</script>
