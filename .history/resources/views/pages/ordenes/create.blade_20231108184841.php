                    ...
                    <div class="divide-y-2">
                        ...
                        <div id="detalleOrdenContainer" class="mt-4">
                            ...
                            <div id="numeroOrdenContainer" class="mb-4">
                                ...
                                <span id="numeroOrden"
                                    class="ml-2 text-lg font-bold text-gray-900 dark:text-gray-400"></span>
                            </div>
                            <div id="meseroContainer" class="mb-4">
                                <label for="mesero">Mesero:</label>
                                <span id="mesero"
                                    class="ml-2 text-lg font-bold text-gray-900 dark:text-gray-400">{{ Auth::user()->name }}</span>
                            </div>
                            <div id="mesaContainer" class="mb-4">
                                <label for="mesa">Número de Mesa:</label>
                                <span id="mesa"
                                    class="ml-2 text-lg font-bold text-gray-900 dark:text-gray-400">0{{ $mesas->numero_mesa }}</span>
                            </div>
                            <table id="detalleOrdenTabla"
