<style>
    .slick-carousel .plato-container {
  margin-right: 20px;
}

.slick-carousel .plato-container:last-child {
  margin-right: 0;
}

.slick-carousel .plato-container {
  width: calc(100% / 4 - 20px); /* Ajusta el número "4" según la cantidad de tarjetas que deseas mostrar en una fila */
}
