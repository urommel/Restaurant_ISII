                                ...
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                    ...
                                    <div class="slick-carousel">
                                        @foreach ($platos as $index => $plato)
                                          <div class="plato-container bg-red-50">
                                            <div class="px-4 py-3">
                                              <a href="#">
                                            ...
                                            <div class="px-4 py-3">
                                              <button onclick="addToCart('{{ $plato->nombre }}', {{ $plato->precio }})" class="w-full px-4 py-2 mt-4 text-sm font-medium text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Agregar al carrito</button>
                                            </div>
                                          </div>
                                        @endforeach
                                      </div>
