                        ...
                        <div id="defaultTabContent">
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                <div class="grid grid-cols-4 gap-4" style="max-height: 400px; overflow-y: scroll;">
                                    @foreach ($platos as $index => $plato)
                                        <div class="p-2 border border-gray-200 rounded-lg shadow bg-red-50 plato-container">
                                            <div class="px-2 py-1">
                                                <a href="#">
                                                    <h5 class="text-base font-semibold text-gray-900">{{ $plato->nombre }}</h5>
                                                </a>
                                            </div>
                                            <div class="flex justify-center">
                                                <a href="#">
                                                    <img class="p-2 rounded-lg" src="/docs/images/products/apple-watch.png" alt="product image" />
                                                </a>
                                            </div>
                                            <div class="px-2 py-1">
                                                <span class="text-lg font-bold text-gray-900">${{ $plato->precio }}</span>
                                            </div>
                                        </div>
                                    @endforeach
                                </div>
