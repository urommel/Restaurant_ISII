            ...
            <div class="md:col-span-1 ">
                ...
                <div class="p-4 bg-white rounded-lg dark:bg-gray-800">
                    ...
                    <div class="p-4 card-body">
                        ...
                        <button type="button" onclick="crearOrden()" class="w-full mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
                            Crear Orden
                        </button>
        ...
        axios.post("/crear-orden", {
            ...
            .then((response) => {
                if (response.data.error) {
                    console.error("Error al crear la orden:", response.data.error);
                } else {
                    // Muestra la factura con los detalles de la orden
    ...
    function obtenerProductos() {
        ...
        filasProductos.forEach((fila) => {
            const producto = {
                ...
                cantidad: parseInt(fila.querySelector("td:nth-child(3) input").value),
                precio: parseFloat(fila.querySelector("td:nth-child(4)").textContent.replace("$", "")),
                precioTotal: parseFloat(fila.querySelector("td:nth-child(5)").textContent.replace("$", ""))
            };
