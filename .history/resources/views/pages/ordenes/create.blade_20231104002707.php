...
<script>
    function addToCart(nombre, precio) {
        ...
        celdaCantidad.innerHTML = '<input type="number" class="w-full text-sm border-gray-300 rounded-md focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50" value="1">';
