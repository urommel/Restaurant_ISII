                ...
                <div
                    ...
                    <div class="flex flex-col items-center pb-10">
                        ...
                        @elseif ($mesa->estado == 'ocupada')
                            ...
                            <div class="flex mt-4 space-x-3 md:mt-6">
                                <a href="{{ route('orden.show', ['orden' => $mesa->orden->id]) }}{{ route('orden.show', ['id' => $mesa->orden->id]) }}"
                        ...
                        @elseif ($mesa->estado == 'reservada')
                            ...
                            <div class="flex mt-4 space-x-3 md:mt-6">
                                <button
                                    class="inline-flex items-center px-4 py-2 text-sm font-medium text-center text-white bg-red-500 rounded-lg cursor-not-allowed opacity-50"
                                    disabled>
                                    Reservada
                                </button>
                            </div>
