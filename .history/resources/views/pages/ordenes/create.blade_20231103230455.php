                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                @foreach ($platos as $plato)
                                    ...
                                    <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                        ...
                                        <div class="px-5 pb-5">
                                            <a href="#">
                                                <h5 class="text-xl font-semibold tracking-tight text-gray-900 dark:text-white">{{ $plato->nombre }}</h5>
                                            </a>
                                            <div class="flex items-center justify-between mt-2.5 mb-5">
                                                <span class="text-3xl font-bold text-gray-900 dark:text-white">${{ $plato->precio }}</span>
                                            </div>
                                        </div>
                                    </div>
                                @endforeach
