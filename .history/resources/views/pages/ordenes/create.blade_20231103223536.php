                                ...
                                @foreach ($platos as $plato)
                                    <div class="flex items-center justify-center">
                                        <div class="max-w-md mx-auto overflow-hidden bg-white rounded-lg shadow-lg">
                                            <img class="object-cover w-full h-64" src="/path/to/image.jpg"
                                                alt="Product Image">
                                            <div class="px-6 py-4">
                                                ...
                                                <div class="flex items-center mt-2">
                                                    ...
                                                    <input type="number"
                                                        class="w-16 px-2 py-1 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg"
                                                        min="1" value="1">
                                                    <button class="px-4 py-2 ml-4 text-white bg-blue-500 rounded-lg">Add
                                                        to Cart</button>
                                                </div>
                                            </div>
                                        </div>
