        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div class="mb-8 md:col-span-2" style="height: calc(100vh - 150px); overflow-y: scroll;">
                ...
                <div class="">
                    {{-- <div class="divide-y-2">
                        <div
                            ...
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800"
                                ...
                                <li class="mr-2">
                                    <button data-tabs-target="#platos" type="button" role="tab"
                                        aria-controls="platos" aria-selected="true"
                                        class="inline-block p-4 rounded-tl-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700">Entrantes</button>
                                </li>
                                <li class="mr-2">
                                    <button data-tabs-target="#platos" type="button" role="tab"
                                        aria-controls="platos" aria-selected="true"
                                        class="inline-block p-4 rounded-tl-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700">Sopas</button>
                                </li>
                                <li class="mr-2">
                                    <button data-tabs-target="#platos" type="button" role="tab"
                                        aria-controls="platos" aria-selected="true"
                                        class="inline-block p-4 rounded-tl-lg hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700">Especialidades</button>
                                </li>
                            </ul>
                            <!-- Contenido para mostrar platos -->
                            <div id="defaultTabContent">
                                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="platos"
                                    role="tabpanel" aria-labelledby="platos-tab">
                    ...
                    <!-- Pestañas para mostrar diferentes categorías -->
        <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800" id="defaultTab" data-tabs-toggle="#defaultTabContent" role="tablist">
            @foreach ($categorias as $categoria)
                <li class="mr-2">
                    <button data-tabs-target="#{{ Str::slug($categoria->nombre) }}" type="button" role="tab"
                        aria-controls="{{ Str::slug($categoria->nombre) }}" aria-selected="{{ $loop->first ? 'true' : 'false' }}"
                        class="inline-block p-4 {{ $loop->first ? 'rounded-tl-lg' : '' }} hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700">{{ $categoria->nombre }}</button>
                </li>
            @endforeach
        </ul>

        <!-- Contenido para mostrar productos según categoría -->
        <div id="defaultTabContent">
            @foreach ($categorias as $categoria)
                <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="{{ Str::slug($categoria->nombre) }}" role="tabpanel" aria-labelledby="{{ Str::slug($categoria->nombre) }}-tab">
                    <div class="slick-arrows">
                        <button type="button" class="slick-prev"></button>
                        <button type="button" class="slick-next"></button>
                    </div>
                    <div class="slick-carousel">
                        @foreach ($productos->where('categoria_id', $categoria->id) as $producto)
                            <div class="mb-8 producto-container bg-red-50">
                                ...
                                <div class="px-4 py-3">
                                    <a href="#">
                                        <h5 class="text-lg font-semibold text-gray-900">{{ $producto->nombre }}</h5>
                                    </a>
                                </div>
                                <div class="flex justify-center">
                                    <a href="#">
                                        <img class="object-cover w-32 h-32 p-4 rounded-lg" src="{{ $producto->url }}" alt="product image" />
                                    </a>
                                </div>
                                <div class="px-4 py-3 mt-auto">
                                ...
                                <div class="px-4 py-3">
                                    <button onclick="addToCart('{{ $producto->nombre }}', {{ $producto->precio }})" class="w-full px-4 py-2 mt-4 text-sm font-medium text-white bg-blue-700 rounded-md hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300">Agregar al carrito</button>
                                </div>
                            </div>
                        @endforeach
                    </div>
