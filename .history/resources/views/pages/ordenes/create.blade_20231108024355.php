...
<script>
    document.addEventListener('DOMContentLoaded', function() {
      ...
      function filtrarPlatosPorCategoria(categoria) {
        ...
        // Por ejemplo:
        const platos = [
          { nombre: 'Ensalada', categoria: 'entradas' },
          { nombre: 'Sopa de Tomate', categoria: 'entradas' },
          { nombre: 'Lomo Saltado', categoria: 'platos-principales' },
          { nombre: 'Pollo a la Brasa', categoria: 'platos-principales' },
          { nombre: 'Tiramisú', categoria: 'postres' },
          { nombre: 'Flan', categoria: 'postres' }
        ];
