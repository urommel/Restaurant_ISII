<x-app-layout>
    ...
    <div class="flex flex-col justify-between border border-gray-200 rounded-lg shadow bebida-container bg-green-50">
        <div class="px-4 py-3">
            <a href="#">
                <h5 class="text-lg font-semibold text-gray-900">{{ $bebida->nombre }}</h5>
            </a>
        </div>
        <div class="flex justify-center">
            <a href="#">
                <img class="object-cover w-32 h-32 p-4 rounded-lg" src="/docs/images/products/beverage.png" alt="product image" />
            </a>
        </div>
        <div class="px-4 py-3 mt-auto">
            <span class="text-xl font-bold text-gray-900">${{ $bebida->precio }}</span>
        </div>
        <div class="px-4 py-3">
            <button onclick="addToCart('{{ $bebida->nombre }}', {{ $bebida->precio }})" class="w-full mt-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Agregar al carrito</button>
        </div>
    </div>
@endforeach
