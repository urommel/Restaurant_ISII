                ...
                <h2 class="mb-4 text-xl font-bold">Lista de Productos</h2>
                    ...
                    <form action="{{ route('orden.store') }}" method="POST" role="form">
                        ...
                        <div class="divide-y-2">
                            ...
                            <div
                                class="relative mt-8 overflow-x-auto border border-transparent shadow-md sm:rounded-lg">
                            ...
                            <button type="button" id="botonCrearOrden" data-store-url="{{ route('orden.store') }}"
...
<script>
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (botonCrearOrden) {
            const storeUrl = botonCrearOrden.getAttribute("data-store-url");

            botonCrearOrden.addEventListener("click", function() {
                // Obtener productos seleccionados
                productos = obtenerProductosSeleccionados();

                // Verificar que al menos haya un producto seleccionado
                if (productos.length === 0) {
                    alert("Selecciona al menos un producto antes de crear la orden.");
                    return;
                }
