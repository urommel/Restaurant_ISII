                ...
                <div class="p-4 bg-white rounded-lg dark:bg-gray-800">
                    ...
                    <div id="pagoFormContainer" style="display: none;">
                        <form id="pagoForm" action="{{ route('orden.pagar', $orden->id) }}" method="POST">
                            ...
                            <button type="submit" id="botonPagar" class="w-full mt-4 text-white bg-green-500 hover:bg-green-600 focus:ring-4 focus:outline-none focus:ring-green-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">
                                Pagar
                            </button>
                        </form>
                    </div>
