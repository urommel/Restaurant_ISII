                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                <div class="flex items-center">
                                    ...
                                    <a href="#" class="w-40 ml-4 overflow-hidden">
                                        <h5 class="text-lg font-semibold text-gray-900 dark:text-white whitespace-nowrap overflow-ellipsis">
                                            {{ $plato->nombre }}
                                        </h5>
                                    </a>
                                    <span class="ml-4 text-xl font-bold text-gray-900 dark:text-white">${{ $plato->precio }}</span>
                                    <input type="number" id="quantity_{{ $plato->id }}" min="1" value="1" class="w-16 px-2 py-1 ml-4 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
