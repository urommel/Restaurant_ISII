                        ...
                        <div id="defaultTabContent">
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                <div class="flex flex-row flex-wrap">
                                    @foreach ($platos as $plato)
                                    <div class="w-full p-4 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
                                        <div class="flex items-center justify-between bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                            <a href="#">
                                                <img class="p-4 rounded-l-lg" src="/docs/images/products/apple-watch.png" alt="product image" />
                                            </a>
                                            <div class="flex flex-col justify-center px-4 py-3">
                                                <div>
                                                    <a href="#">
                                                        <h5 class="text-lg font-semibold text-gray-900 truncate dark:text-white">{{ $plato->nombre }}</h5>
                                                    </a>
                                                </div>
                                                <div>
