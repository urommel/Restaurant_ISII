                    ...
                    <div
                        ...
                        <div id="defaultTabContent">
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                {{-- <div class="flex flex-wrap">
                                    @foreach ($platos as $index => $plato)
                                        @if ($index < 4)
                                            <div class="w-1/2 p-2 sm:w-1/4 md:w-1/4 lg:w-1/4 xl:w-1/4">
                                                <div class="h-full overflow-hidden bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 aspect-w-1 aspect-h-1">
                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="services"
                                ...
                                @endforeach --}}
                                @foreach ($bebidas as $bebida)
    <div class="flex items-center bg-fuchsia-50 p-4 rounded-lg mb-4">
        <a href="#" class="flex-shrink-0">
            <img class="p-4 rounded-lg" src="/docs/images/products/apple-watch.png" alt="product image" />
        </a>
        <a href="#" class="ml-4">
        ...
        <span class="ml-4 text-xl font-bold text-gray-900 dark:text-white">${{ $bebida->precio }}</span>
        <input type="number" id="quantity_{{ $bebida->id }}" min="1" value="1"
            class="w-16 px-2 py-1 ml-4 text-sm text-gray-900 bg-white border border-gray-300 rounded-lg dark:bg-gray-800 dark:border-gray-700 dark:text-gray-400">
        <button onclick="agregarAlCarrito('{{ $bebida->nombre }}', {{ $bebida->precio }}, document.getElementById('quantity_{{ $bebida->id }}').value)"
            class="ml-4 text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Añadir</button>
    </div>
@endforeach
