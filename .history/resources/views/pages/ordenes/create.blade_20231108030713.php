                ...
                <div class="">
                    <div class="divide-y-2">
                        <div
                            ...
                            <!-- Bucle para mostrar productos según categoría -->
                                    ...
                                    <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800"
                                        ...
                                        <div class="slick-carousel">
                                            @foreach ($productos->where('categoria_id', $categoria->id) as $producto)
                                                    ...
                                                    <table
                                                        ...
                                                        <thead
                                                            ...
                                                            <tr>
                                                                ...
                                                                <th scope="col" class="px-6 py-3">Precio total de
                                                                    unidad</th>
                                                            </tr>
                                                        </thead>
                                                ...
                                                <div id="montoTotalContainer" class="mt-4 text-right"
                                                    style="display: none;">
                            ...
                            <div class="md:col-span-1 ">
                                ...
                                <div class="p-4 bg-white rounded-lg dark:bg-gray-800">
                                    <div class="px-4 py-3 bg-transparent border-b card-header">
                                        <h5 class="mb-0 text-16">Mesa: <span
