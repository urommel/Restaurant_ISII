                                ...
                                <div class="flex flex-row flex-wrap">
                                    ...
                                    <div class="w-full p-2 sm:w-1/2 md:w-1/3 lg:w-1/4 xl:w-1/5">
                                        <div class="overflow-hidden bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                                            <div class="px-2 py-1">
                                                <a href="#">
                                                    <h5 class="text-sm font-semibold text-gray-900 dark:text-white">{{ $plato->nombre }}</h5>
                                                </a>
                                            </div>
                                            ...
                                            <div class="px-2 py-1">
                                                <span class="text-sm font-bold text-gray-900 dark:text-white">${{ $plato->precio }}</span>
                                            </div>
                                        </div>
                                    </div>
                                    @endforeach
