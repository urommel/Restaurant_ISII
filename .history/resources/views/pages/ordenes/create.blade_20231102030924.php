...
En este código, he utilizado una rejilla (grid) con dos columnas (grid-cols-2) para dividir la sección en dos partes: una para los productos y otra para la factura. Espero que esto sea más cercano a lo que buscas. Si necesitas más ajustes, no dudes en hacérmelo saber.
