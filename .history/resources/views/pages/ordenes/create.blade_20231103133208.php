        ...
        <div class="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <div class="mb-8 md:col-span-2">
                ...
                <div class="divide-y-2">
                    <div
                        class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 mb-8">
                    ...
                    <div class="relative overflow-x-auto shadow-md sm:rounded-lg mt-8 border border-transparent">
