                            ...
                            <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="about"
                                ...
                                <div class="flex flex-wrap">
                                    ...
                                    <div class="flex flex-col justify-center ml-4">
                                        <h5 class="text-lg font-semibold text-center text-gray-900 dark:text-white md:text-left">
                                            {{ $plato->nombre }}
                                        </h5>
                                        <span class="ml-auto text-xl font-bold text-gray-900 dark:text-white md:ml-0">
                                            ${{ $plato->precio }}
                                        </span>
                                        <div class="flex items-center mt-4">
                                            ...
                                            <button onclick="agregarAlCarrito('{{ $plato->nombre }}', {{ $plato->precio }},
