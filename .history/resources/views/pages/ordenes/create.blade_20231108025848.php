                        ...
                        <div
                            ...
                            <ul class="flex flex-wrap text-sm font-medium text-center text-gray-500 border-b border-gray-200 rounded-t-lg bg-gray-50 dark:border-gray-700 dark:text-gray-400 dark:bg-gray-800"
                                ...
                                @foreach ($categorias as $categoria)
                                    <li class="mr-2">
                                        <button data-tabs-target="#{{ Str::slug($categoria->nombre) }}" type="button" role="tab" aria-controls="{{ Str::slug($categoria->nombre) }}" aria-selected="{{ $loop->first ? 'true' : 'false' }}" class="inline-block p-4 {{ $loop->first ? 'rounded-tl-lg' : '' }} hover:bg-gray-100 dark:bg-gray-800 dark:hover:bg-gray-700">{{ $categoria->nombre }}</button>
                                                    ...
                                                    <div class="flex justify-center">
                                                        <a href="#">
                                                            <img class="object-cover w-32 h-32 p-4 rounded-lg"
                                                                src="{{ $producto->imagen }}" alt="product image" />
                                                        </a>
                                                    </div>
