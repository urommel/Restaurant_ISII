...
<x-app-layout>
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex-grow px-4">
                                    ...
                                    <div class="flex items-center justify-between mt-2">
                                        ...
                                        <button onclick="agregarAlCarrito('plato', '{{ $plato->nombre }}', {{ $plato->precio }})" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                            ...
                            <div class="flex items-center">
                                ...
                                <div class="flex-grow px-4">
                                    ...
                                    <div class="flex items-center justify-between mt-2">
                                        ...
                                        <button onclick="agregarAlCarrito('bebida', '{{ $bebida->nombre }}', {{ $bebida->precio }})" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                    </div>
                                </div>
                            </div>
                        @endforeach
    ...
    <script>
        ...
        function agregarOrden(item) {
            let tbody = document.getElementById('ordenItems');
            ...
            // Llenar las celdas con la información del item
            nameCell.textContent = item.nombre;
            quantityCell.textContent = 1; // Puedes ajustar la cantidad según tu lógica
            priceCell.textContent = `$${item.precio.toFixed(2)}`;
            totalCell.textContent = `$${item.precio.toFixed(2)}`;

            // Crear el botón de remover
            let removeButton = document.createElement('button');
            removeButton.textContent = 'Remove';
            removeButton.className = 'text-white bg-red-500 hover:bg-red-600 focus:ring-4 focus:outline-none focus:ring-red-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800';
            removeButton.addEventListener('click', function () {
                // Puedes agregar lógica para remover el item del carrito y actualizar la tabla
                newRow.remove();
            });
        ...
        function agregarAlCarrito(tipo, nombre, precio) {
            ...
            // Actualizar la lista en el carrito y la tabla de órdenes
            actualizarCarrito();
            agregarOrden(item);
        }
    </script>
