...
<x-app-layout>
        ...
        <div class="flex">
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <ul class="hidden text-sm font-medium text-center text-gray-500 divide-x divide-gray-200 rounded-lg sm:flex dark:divide-gray-600 dark:text-gray-400" id="fullWidthTab" data-tabs-toggle="#fullWidthTabContent" role="tablist">
                    ...
                    <li class="w-full">
                        <button id="orders-tab" data-tabs-target="#orders" type="button" role="tab" aria-controls="orders" aria-selected="false" class="inline-block w-full p-4 bg-gray-50 hover:bg-gray-100 focus:outline-none dark:bg-gray-700 dark:hover:bg-gray-600">Órdenes</button>
                    </li>
                </ul>
                <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                    ...
                    <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="orders" role="tabpanel" aria-labelledby="orders-tab">
    ...
    <script>
        ...
        function agregarAlCarrito(tipo) {
            ...
            if (!select) {
                console.error(`No se encontró el elemento con ID ${tipo}_id`);
                return;
            }
    
            let selectedItem = select.options[select.selectedIndex];
            if (!selectedItem) {
                console.error(`No se seleccionó ningún elemento para ${tipo}`);
                return;
            }
