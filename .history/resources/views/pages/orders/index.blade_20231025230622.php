                ...
                <div
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg"
                            src="{{asset('images/mesa.jpg')}}" alt="mesas" />
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-4">
            @foreach ($mesas as $mesa)
                <div class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex flex-col items-center pb-10">
                        <img class="w-24 h-24 mb-3 rounded-full shadow-lg" src="{{ asset('images/mesa.jpg') }}" alt="mesas" />
                        <h5 class="mb-1 text-xl font-medium text-gray-900 dark:text-white"></h5>
                        <span class="text-sm text-gray-500 dark:text-gray-400">Mesa: Nº{{ $mesa->numero_mesa }}</span>
                        <div class="flex mt-4 space-x-3 md:mt-6">
                            <a href="{{ route('ordenes.create', ['mesas_id' => $mesa->id]) }}"
