...
<input type="checkbox" id="general_customer" name="general_customer" onchange="toggleCustomerSelect({{ $general_client->id }})">
<label for="general_customer">Cliente general</label>
    ...
    <script>
        ...
        function toggleCustomerSelect(generalClientId) {
            var checkBox = document.getElementById("general_customer");
            var select = document.getElementById("client_id");

            // Si el checkbox está marcado, selecciona el cliente general
            if (checkBox.checked == true) {
                select.value = generalClientId;
            } else {
                select.value = "";
            }
        }
