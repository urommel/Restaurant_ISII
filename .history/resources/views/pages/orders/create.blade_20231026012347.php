    ...
    <div class="w-full px-4 py-8 mx-auto sm:px-6 lg:px-8 max-w-9xl">
        <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
            ...
            <div class="lg:w-8/12">
                    ...
                    <div class="card-body">
                        ...
                        <div class="flex border-b pb-3">
                            ...
                            <div class="flex-grow-1 self-center overflow-hidden">
                                <div>
                                    <h5 class="truncate text-16"><a href="ecommerce-product-detail" class="text-dark">Nike N012 Running Shoes</a></h5>
                ...
                <!-- Repite la estructura anterior para los demás productos -->
            ...
            <!-- Columna derecha -->
            <div class="lg:w-4/12 mt-5 lg:mt-0">
                <div class="card border shadow-none">
