...
<x-app-layout>
                                ...
                                <div class="flex-grow px-4">
                                    ...
                                    <div class="flex items-center justify-between mt-2">
                                        ...
                                        <input type="number" id="quantity_{{ $plato->id }}" min="1"
                                            value="1">
                                        <button
                                            onclick="agregarAlCarrito('plato', '{{ $plato->nombre }}', {{ $plato->precio }}, document.getElementById('quantity_{{ $plato->id }}').value)"
                                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                                    </div>
                                </div>
                            </div>
        ...
        <div class="flex items-center">
            ...
            <div class="flex-grow px-4">
                ...
                <div class="flex items-center justify-between mt-2">
                    ...
                    <button onclick="agregarAlCarrito('{{ $bebida->nombre }}', {{ $bebida->precio }})"
                        class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Add</button>
                </div>
            </div>
        </div>
    @endforeach
                    ...
                    <!-- Contenido de Órdenes -->
                    <!-- Contenido de Órdenes -->
                    <!-- Contenido de Órdenes (Tabla de productos en el carrito) -->
                    <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800 mt-4" id="orders"
    ...
    <script>
        ...
        function agregarAlCarrito(nombre, precio, cantidad) {
            // Aquí deberías agregar la lógica para obtener los detalles del producto seleccionado
            // y agregarlo al carrito, luego actualizar la tabla de productos en el carrito
            // Puedes hacer esto dinámicamente con JavaScript y AJAX si es necesario
            // Ejemplo de cómo puedes actualizar la tabla (debes ajustarlo según tu lógica):

            // Obtén los detalles del producto (esto es solo un ejemplo, reemplázalo con tus propios datos)
            // var producto = {
            ...
            var fila = "<tr><td>" + producto.nombre + "</td><td>" + producto.cantidad + "</td><td>" + producto
                .precio_unitario + "</td><td>" + producto.total + "</td></tr>";
