<x-app-layout>
        ...
        <div class="flex">
            ...
            <div class="w-4/12 mt-5 lg:mt-0">
                <div class="border shadow-none card">
                    ...
                    <div class="px-4 py-3 bg-transparent border-b card-header">
                        <h5 class="mb-0 text-16">Mesero: <span class="float-right"> {{ Auth::user()->name }}</span></h5>
                    </div>
    ...
    if (carrito.length === 0) {
        alert("Agrega productos al carrito antes de crear la orden.");
        return;
    }
    ...
    // Obtener el cliente seleccionado (si no es un cliente general)
    if (!document.getElementById("general_customer").checked) {
        cliente = document.getElementById("client_id").value;
    }

    // Aquí puedes realizar una solicitud AJAX para enviar la orden al servidor
    // Puedes usar la biblioteca axios o el objeto XMLHttpRequest nativo de JavaScript
    // Ajusta la URL y los datos según tu estructura en el servidor

    axios.post('/guardar-orden', {
        mesa: mesa,
        cliente: cliente,
        mesero: mesero,
    ...
    .then(function (response) {
        // La orden se ha guardado exitosamente, puedes realizar acciones adicionales si es necesario
