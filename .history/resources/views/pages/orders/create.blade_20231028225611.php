        ...
        <div class="flex">
            <div class="w-full bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                ...
                <div id="fullWidthTabContent" class="border-t border-gray-200 dark:border-gray-600">
                    ...
                    <div class="hidden p-4 bg-white rounded-lg md:p-8 dark:bg-gray-800" id="orders" role="tabpanel"
                        aria-labelledby="orders-tab">
                        <!-- Ejemplo de cómo mostrar órdenes -->
                        ...
                        <div class="relative overflow-x-auto">
                            <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                                <thead>
                                    <tr>
                                        <th class="px-6 py-3">Número de Orden</th>
                                ...
                                <tbody>
                                    <!-- Loop para mostrar órdenes -->
                                    @foreach ($ordenes as $orden)
                                        <tr>
                                            <td class="px-6 py-4">{{ $orden->numero }}</td>
                                            <td class="px-6 py-4">{{ $orden->producto }}</td>
                                            <td class="px-6 py-4">{{ $orden->cantidad }}</td>
                                            <td class="px-6 py-4">${{ $orden->precio_unitario }}</td>
