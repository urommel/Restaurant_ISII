                        ...
                        <div class="lg:hidden lg:sidebar-expanded:block 2xl:block">
                            <ul class="pl-9 mt-1 @if (!in_array(Request::segment(1), ['community'])) {{ 'hidden' }} @endif"
                                ...
                                @can('Ver-Platos')
                                    <li class="mb-1 last:mb-0">
                                        <a class="block text-slate-400 hover:text-slate-200 transition duration-150 truncate @if (Route::is('users-tabs')) {{ '!text-indigo-500' }} @endif"
                                            href="{{ route('<div class="container mx-auto mt-8">
                                                <h1 class="text-3xl font-semibold mb-4">Lista de Platos</h1>
                                        
                                                <a href="{{ route('platos.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded-md mb-4">Crear Nuevo Plato</a>
                                                    ...
                                                    <ul>
                                                        @foreach ($platos as $plato)
                                                            <li class="mb-4">
                                                                ...
                                                                @endif
                                                                <div class="mt-4">
                                                                    <a href="{{ route('platos.edit', $plato->id) }}" class="text-blue-500">Editar</a>
                                                                    <form action="{{ route('platos.destroy', $plato->id) }}" method="post" class="inline">
                                                                        @csrf
                                                                        @method('DELETE')
