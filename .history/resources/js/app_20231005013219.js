...
// // Configura el formato de fecha deseado
// const dateFormat = 'YYYY-MM-DD';

// // Inicializa Pikaday con el input deseado
// const dateInput = document.getElementById('fechaInput');
// if (dateInput) {
//     new Pikaday({
//         field: dateInput,
//         format: dateFormat,
//         yearRange: [moment().year(), moment().year() + 5], // Ajusta según tus necesidades
//         showYearDropdown: true,
//         theme: 'dark', // Agrega la clase 'dark' para el modo oscuro
//     });
// }
