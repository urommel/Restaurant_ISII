...
class OrdersController extends Controller
{
    ...
    {
        //
        // Si el checkbox "Cliente General" está marcado, tratar al cliente como un cliente general
        if ($request->has('general_customer')) {
            $client_id = null; // O cualquier valor que represente a un cliente general en tu aplicación
        } else {
            $client_id = $request->input('client_id');
        }

        // El resto de tu código para procesar el formulario...
    }
