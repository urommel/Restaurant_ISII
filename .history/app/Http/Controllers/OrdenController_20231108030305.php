...
class OrdenController extends Controller
{
    ...
    public function create($mesas_id)
    {
        ...
        foreach ($categorias as $categoria) {
            $productosPorCategoria[$categoria->id] = $productos->where('categoria_id', $categoria->id);
        }

        dd($categorias, $productos);

        return view('pages.ordenes.create', compact('mesas', 'clients', 'productos', 'users', 'categorias', 'productosPorCategoria'));
    }
