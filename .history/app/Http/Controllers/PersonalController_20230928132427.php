...
class PersonalController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        $personal->salario = $request->input('salario');
        $personal->user->email = $request->input('email');
        $personal->user->password = Hash::make($request->input('password'));

        // Actualizar el rol (si es necesario)
        $personal->user->syncRoles([$request->input('role_id')]);

        // Guardar los cambios en el registro y el usuario relacionado
        $personal->save();
        $personal->user->save();
