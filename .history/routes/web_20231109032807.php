...
Route::middleware(['auth', 'verified'])->group(function () {
    ...
    Route::get('orden/{orden}', [OrdenController::class, 'show'])->name('orde.show');
    Route::patch('/orden/{orden}/pagar', [OrdenController::class, 'pagar'])->name('orde.pagar');
    Route::patch('/orden/{orden}/pagar', [OrdenController::class, 'pagar'])->name('orden.pagar');
